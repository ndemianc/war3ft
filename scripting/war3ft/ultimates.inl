...
ULT_RemoveCharge( id, iFuncID )
{
	...
	// sdemian
	client_print_color_msg( id, "%s %L", g_MODclient_color, id, "CLIENT_PRINT_ULT_REMOVE_CHARGE" );
...
ULT_Blocked( id )
{
	...
	// sdemian
	client_print_color_msg( id, "%s %L", g_MODclient_color, id, "CLIENT_PRINT_ULT_BLOCKED" );
