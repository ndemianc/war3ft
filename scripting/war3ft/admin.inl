...
ADMIN_SetLevel( id, szTarget[], iLevel )
{
	...
	while ( ( iTarget = FindTarget( iTarget, szTarget ) ) > 0 )
	{
		...
		// client_print( iTarget, print_chat, "%s %L", g_MODclient, iTarget, "CLIENT_PRINT_ADMIN_SET_LEVEL", iLevel );
		// sdemian
		client_print_color_msg( iTarget, "%s %L", g_MODclient_color, iTarget, "CLIENT_PRINT_ADMIN_SET_LEVEL", iLevel);
...
ADMIN_GiveXP( id, szTarget[], iXP )
{
	...
	while ( ( iTarget = FindTarget( iTarget, szTarget ) ) > 0 )
	{
		...
		// sdemian
		client_print_color_msg( iTarget, "%s %L", g_MODclient_color, iTarget, "THE_ADMIN_GAVE_YOU_EXPERIENCE", iXP );
...
ADMIN_GiveItem( id, szTarget[], iItemID )
{
	...
	while ( ( iTarget = FindTarget( iTarget, szTarget ) ) > 0 )
	{
		// client_print( iTarget, print_chat, "%s %L", g_MODclient, iTarget, "CLIENT_PRINT_ADMIN_GIVE_ITEM", szItemName );
		// sdemian
		client_print_color_msg( iTarget, "%s %L", g_MODclient_color, iTarget, "CLIENT_PRINT_ADMIN_GIVE_ITEM", szItemName );
