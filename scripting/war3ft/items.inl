...
ITEM_Init()
{
	...
	ITEM_COST[ITEM_CLOAK]	    = 875;			// Cloak of Shadows
	ITEM_COST[ITEM_MASK]	    = 1725;			// Mask of Death
	ITEM_COST[ITEM_NECKLACE]	= 625;			// Necklace of Immunity
	ITEM_COST[ITEM_FROST]	    = 1725;			// Orb of Frost
	ITEM_COST[ITEM_HEALTH]	    = 875;			// Periapt of Health
	ITEM_COST[ITEM_TOME]	    = 3000;			// Tome of Experience
	ITEM_COST[ITEM_SCROLL]	    = 8000;			// Scroll of Respawning
	ITEM_COST[ITEM_PROTECTANT]	= 1200;			// Mole Protectant
	...
	ITEM_COST[ITEM_GLOVES]	    = 1625;			// Flaming Gloves of Warmth
...
public ITEM_CanBuy( id, iItem )
{
	...
	// sdemian
	// User has purchased ankh when it disabled on this map
	else if ( iItem == ITEM_ANKH && g_bAnkhDisabled )
	{
		client_print( id, print_chat, "Ankh is disabled on this map!" );
...
ITEM_DisplayMessage( id, iItem )
{
	...
	switch ( iItem )
	{
		case ITEM_ANKH:
		{
			...
			*/
			// sdemian
			(g_MOD == GAME_DOD)								? client_print_color_msg( id, "%s %L", g_MODclient_color, id, "DOD_INFO_SHOPMENU_1" ) : 0;
			(g_MOD == GAME_CSTRIKE || g_MOD == GAME_CZERO)	? client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU_1" ) : 0;
		}
		...
		case ITEM_BOOTS:
		{
			if ( g_MOD == GAME_CSTRIKE || g_MOD == GAME_CZERO )
			{
				...
				// sdemian
				client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU_2", ( ( get_pcvar_float( CVAR_wc3_boots ) ) * 100.00 ) );
			}
			...
			else if ( g_MOD == GAME_DOD )
			{
				...
				// sdemian
				client_print_color_msg( id, "%s %L", g_MODclient_color, id, "DOD_INFO_SHOPMENU_2" );
			}
		}
		...
		case ITEM_CLAWS:
		{
			...
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU_3", get_pcvar_num( CVAR_wc3_claw ) );
		}
		...
		case ITEM_CLOAK:
		{
			...
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU_4", fInvis );
		}
		...
		case ITEM_MASK:
		{
			...
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU_5", fMask );
		}
		...
		case ITEM_NECKLACE:
		{
			...
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU_6", NECKLACE_CHARGES );
		}
		...
		case ITEM_FROST:
		{
			...
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU_7", fFrost );
		}
		...
		case ITEM_HEALTH:
		{
			...
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU_8", get_pcvar_num( CVAR_wc3_health ) );
		}
		...
		case ITEM_SCROLL:
		{
			if ( is_user_alive( id ) )
			{
				...
				// sdemian
				client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU2_1" );
			}
			...
			else
			{
				...
				// sdemian
				client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU2_1_DEAD" );
			}
		}
		...
		case ITEM_PROTECTANT:
		{
			...
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU2_2" );
		}
		...
		case ITEM_HELM:
		{
			...
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU2_3", HELM_CHARGES );
		}
		...
		case ITEM_AMULET:
		{
			...
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU2_4" );
		}
		...
		case ITEM_SOCK:
		{
			...
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU2_5" );
		}
		...
		case ITEM_GLOVES:
		{
			...
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU2_6", get_pcvar_num( CVAR_wc3_glove_timer ) );
		}
		...
		case ITEM_RING:
		{
			...
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU2_7" );
		}
		...
		case ITEM_CHAMELEON:
		{
			...
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU2_8" );
		}
		...
		case ITEM_MOLE:
		{
			...
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU2_9" );
		}
	}
}
...
ITEM_Tome( id )
{
	...
	if ( iBonusXP != 0 )
	{
		...
		// sdemian
		client_print_color_msg( id, "%s %L", g_MODclient_color, id, "INFO_SHOPMENU_9", iBonusXP);
	}
...
public _ITEM_Glove_Give( id )
{
	...
	{
		WC3_StatusText( id, TXT_TIMER, "%L", id, "UNTIL_YOUR_NEXT_GRENADE", g_iGloveTimer[id] );
