...
public bomb_defusing( defuser )
{
	...
	if ( !bHasBegunPlantingOrDefusing[defuser] )
	{
		...
		if ( iBonusXP != 0 )
		{
			// client_print( defuser, print_chat, "%s %L", g_MODclient_color, defuser, "AWARD_FOR_DEFUSING_BOMB", iBonusXP );
			// sdemian
			client_print_color_msg( defuser, "%s %L", g_MODclient_color, defuser, "AWARD_FOR_DEFUSING_BOMB", iBonusXP);
		}
	}
...
public bomb_defused( defuser )
{
	...
	if ( iBonusXP != 0 )
	{
		// client_print( defuser, print_chat, "%s %L", g_MODclient_color, defuser, "AWARD_FOR_DEFUSED_BOMB", iBonusXP );
		// sdemian
		client_print_color_msg( defuser, "%s %L", g_MODclient_color, defuser, "AWARD_FOR_DEFUSED_BOMB", iBonusXP);
	}
...
public bomb_planting( planter )
{
	...
	if ( !bHasBegunPlantingOrDefusing[planter] )
	{
		...
		if ( iBonusXP != 0 )
		{
			// client_print( planter, print_chat, "%s %L", g_MODclient_color, planter, "AWARD_FOR_PLANTING_BOMB", iBonusXP );
			// sdemian
			client_print_color_msg( planter, "%s %L", g_MODclient_color, planter, "AWARD_FOR_PLANTING_BOMB", iBonusXP);
		}
	}
...
public bomb_planted( planter )
{
	...
	if ( iBonusXP != 0 )
	{
		// client_print( planter, print_chat, "%s %L", g_MODclient_color, planter, "AWARD_FOR_PLANTED_BOMB", iBonusXP );
		// sdemian
		client_print_color_msg( planter, "%s %L", g_MODclient_color, planter, "AWARD_FOR_PLANTED_BOMB", iBonusXP);
	}
...
public on_PlayerAction()
{
	...
	if (equal(sAction,"Spawned_With_The_Bomb"))
	{
		...
		{
			// client_print( id, print_chat, "%s %L", g_MODclient_color, id, "AWARD_FOR_SPAWNING_WITH_BOMB", iBonusXP );
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "AWARD_FOR_SPAWNING_WITH_BOMB", iBonusXP);
		}
	}
	// Dropped bomb 
	else if (equal(sAction,"Dropped_The_Bomb"))
	{
		...
		if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_objectives ) )
		{
			// client_print( id, print_chat, "%s %L", g_MODclient_color, id, "AWARD_FOR_LOST_BOMB", -1 * iBonusXP );
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "AWARD_FOR_LOST_BOMB", iBonusXP);
		}
	}
	// Picked up bomb 
	...
	{ 
		...
		if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_objectives ) )
		{
			// client_print( id, print_chat, "%s %L", g_MODclient_color, id, "AWARD_FOR_PICKING_UP_BOMB", iBonusXP );
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "AWARD_FOR_PICKING_UP_BOMB", iBonusXP);
		}
	}
	// Hostage touched 
	else if (equal(sAction,"Touched_A_Hostage"))
	{
		...
		if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_objectives ) )
		{
			// client_print( id, print_chat, "%s %L", g_MODclient_color, id, "AWARD_FOR_BEGINNING_HOSTAGE_RESCUE", iBonusXP );
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "AWARD_FOR_BEGINNING_HOSTAGE_RESCUE", iBonusXP);
		}
	}
	// Hostage rescued 
	else if (equal(sAction,"Rescued_A_Hostage"))
	{
		...
		if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_objectives ) )
		{
			// client_print( id, print_chat, "%s %L", g_MODclient_color, id, "AWARD_FOR_RESCUING_HOSTAGE", iBonusXP );
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "AWARD_FOR_RESCUING_HOSTAGE", iBonusXP);
		}
	}
	// Hostage killed 
	else if (equal(sAction,"Killed_A_Hostage"))
	{
		...
		if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_objectives ) )
		{
			// client_print( id, print_chat, "%s %L", g_MODclient_color, id, "AWARD_FOR_KILLING_HOSTAGE", -1 * iBonusXP );
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "AWARD_FOR_KILLING_HOSTAGE", iBonusXP);
		}
	}
	// VIP spawn 
	...
	{ 
		...
		if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_objectives ) )
		{
			// client_print( id, print_chat, "%s %L", g_MODclient_color, id, "AWARD_FOR_SPAWN_AS_VIP", iBonusXP );
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "AWARD_FOR_SPAWN_AS_VIP", iBonusXP);
		}
	}
	// VIP escaped 
	else if (equal(sAction,"Escaped_As_VIP"))
	{
		...
		if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_objectives ) )
		{
			// client_print( id, print_chat, "%s %L", g_MODclient_color, id, "AWARD_FOR_ESCAPED_VIP", iBonusXP );
			// sdemian
			client_print_color_msg( id, "%s %L", g_MODclient_color, id, "AWARD_FOR_ESCAPED_VIP", iBonusXP);
		}
	}
}
...
XP_onDeath( iVictim, iAttacker, iWeaponIndex, iHeadshot )
{
	...
	if ( get_user_team( iAttacker ) == get_user_team( iVictim ) )
	{
		...
		if ( iBonusXP != 0 )
		{
			// client_print( iAttacker, print_chat, "%s %L", g_MODclient_color, iAttacker, "AWARD_FOR_TEAM_KILL", -1 * iBonusXP );
			// sdemian
			client_print_color_msg( iAttacker, "%s %L", g_MODclient_color, iAttacker, "AWARD_FOR_TEAM_KILL", iBonusXP);
		}
	...
	else
	{
		...
		{
			// client_print( iAttacker, print_chat, "%s %L", g_MODclient_color, iAttacker, "AWARD_FOR_ENEMY_KILL", iBonusXP );
			// sdemian
			client_print_color_msg( iAttacker, "%s %L", g_MODclient_color, iAttacker, "AWARD_FOR_ENEMY_KILL", iBonusXP);
		}
		...
		if ( iHeadshot )
		{
			...
			if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_kill_obj ) )
			{
				// client_print( iAttacker, print_chat, "%s %L", g_MODclient_color, iAttacker, "AWARD_FOR_KILL_HEADSHOT", iBonusXP );
				// sdemian
				client_print_color_msg( iAttacker, "%s %L", g_MODclient_color, iAttacker, "AWARD_FOR_KILL_HEADSHOT", iBonusXP);
			}
		}
		...
		for ( new i = 0; i < MAXPLAYERS; i++ )
		{
			...
			if ( g_iDamageDealt[i][iVictim] > 0 && iAttacker != i )
			{
				...
				if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_kill_obj ) )
				{
					// client_print( i, print_chat, "%s %L", g_MODclient_color, i, "AWARD_FOR_KILL_ASSIST", iBonusXP );
					// sdemian
					client_print_color_msg( i, "%s %L", g_MODclient_color, i, "AWARD_FOR_KILL_ASSIST", iBonusXP);
				}
		...
		if ( g_MOD == GAME_CSTRIKE || g_MOD == GAME_CZERO )
		{
			...
			if ( g_iPlayerRole[iVictim] == PLR_HOSTAGE_RESCUER )
			{
				...
				if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_kill_obj ) )
				{
					// client_print( iAttacker, print_chat, "%s %L", g_MODclient_color, iAttacker, "AWARD_FOR_KILL_HOSTAGE_RESCUER", iBonusXP );
					// sdemian
					client_print_color_msg( iAttacker, "%s %L", g_MODclient_color, iAttacker, "AWARD_FOR_KILL_HOSTAGE_RESCUER", iBonusXP);
				}
			}
			...
			else if ( g_iPlayerRole[iVictim] == PLR_BOMB_DEFUSER )
			{
				...
				if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_kill_obj ) )
				{
					// client_print( iAttacker, print_chat, "%s %L", g_MODclient_color, iAttacker, "AWARD_FOR_KILL_DEFUSER", iBonusXP );
					// sdemian
					client_print_color_msg( iAttacker, "%s %L", g_MODclient_color, iAttacker, "AWARD_FOR_KILL_DEFUSER", iBonusXP);
				}
			}
			...
			else if ( g_iPlayerRole[iVictim] == PLR_BOMB_PLANTER )
			{
				...
				if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_kill_obj ) )
				{
					// client_print( iAttacker, print_chat, "%s %L", g_MODclient_color, iAttacker, "AWARD_FOR_KILL_PLANTER", iBonusXP );
					// sdemian
					client_print_color_msg( iAttacker, "%s %L", g_MODclient_color, iAttacker, "AWARD_FOR_KILL_PLANTER", iBonusXP);
				}
			}
			...
			else if ( g_iPlayerRole[iVictim] == PLR_BOMB_CARRIER )
			{
				...
				if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_kill_obj ) )
				{
					// client_print( iAttacker, print_chat, "%s %L", g_MODclient_color, iAttacker, "AWARD_FOR_KILL_BOMB_CARRIER", iBonusXP );
					// sdemian
					client_print_color_msg( iAttacker, "%s %L", g_MODclient_color, iAttacker, "AWARD_FOR_KILL_BOMB_CARRIER", iBonusXP);
				}
			}
			// user killed the VIP
			else if ( g_iPlayerRole[iVictim] == PLR_VIP )
			{
				...
				if ( iBonusXP != 0 && get_pcvar_num( CVAR_wc3_show_objectives ) )
				{
					// client_print( iAttacker, print_chat, "%s %L", g_MODclient_color, iAttacker, "AWARD_FOR_KILL_VIP", iBonusXP );
					// sdemian
					client_print_color_msg( iAttacker, "%s %L", g_MODclient_color, iAttacker, "AWARD_FOR_KILL_VIP", iBonusXP);
				}
			}
		}
...
XP_WinRound( iWinner )
{
	...
	for ( i = 0; i < numberofplayers; i++ )
	{
		...
		if ( get_user_team( id ) == iWinner )
		{
			...
			{				
				// client_print( id, print_chat, "%s %L", g_MODclient_color, id, "AWARD_FOR_WINNING_ROUND", iBonusXP );
				// sdemian
				client_print_color_msg( id, "%s %L", g_MODclient_color, id, "AWARD_FOR_WINNING_ROUND", iBonusXP);
			}
		}
	}
}
...
XP_Configure()
{
	...
	if ( g_MOD == GAME_CSTRIKE || g_MOD == GAME_CZERO )
	{
		...
		fWpnXPMultiplier[CSW_KNIFE			]	= 4.0;
	...
	{
		fWpnXPMultiplier[DODW_AMERKNIFE			] = 4.0;
		fWpnXPMultiplier[DODW_GERKNIFE			] = 4.0;
		fWpnXPMultiplier[DODW_BRITKNIFE			] = 4.0;
		fWpnXPMultiplier[DODW_GARAND_BUTT		] = 4.0;
...
public XP_Reset(id)
{
	...
	// client_print( id, print_chat, "%s %L", g_MODclient_color, id, "YOUR_XP_HAS_BEEN_RESET" );
	// sdemian
	client_print_color_msg( id, "%s %L", g_MODclient_color, id, "YOUR_XP_HAS_BEEN_RESET" );
